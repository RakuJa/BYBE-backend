...
- Update deps to solve spell parsing error

## [5.0.0] - 2026-07-09

### Added

- Add conditions endpoint & data, swap pglite dependency (#2)
- Add ability to shutdown correctly db and initialize it from third parties (e.g. app) (#5)

### Feature

- Separate BYBE core from Backend, compact routes logic, use of pglite (#1)
- Move from pglite to postgres embedded (windows compat)

### Removed

- Remove unused deps from actix-web, update db version (#4)
- Remove spammy sql messages on startup

## [4.1.0] - 2026-03-14

### Added

- Add workflow for dev builds (#120)
- Add ranges endpoint (#129)

### Feature

- Introduce hazard endpoint, list and random calculator (#123)
- Swap pre-commit with prek, improve pre-commit process (#124)
- Replace log with tracing (#125)
- Change action struct to contain traits (#128)

### Fixed

- Npc not generating when asking for specific gender without ancestry (#130)

## [4.0.2] - 2026-02-21

### Feature

- Consider only valid item/creature, filtering out item obtained by class feat.
...
- Freeze workflow actions version
...
- Add test to CI
- Add share endpoint, major generics and trait refactor (#112)

### Feature

- Introduce starfinder support (#111)
- Reduce name generation randomness (#114)

### Fixed

- Returning different number of items than requested, add test to avoid regressions (#109)
- More equippable than requested caused by rounding up (#110)
...
[5.0.1]: https://github.com/RakuJa/BYBE-backend/compare/v5.0.0..v5.0.1
[5.0.0]: https://github.com/RakuJa/BYBE-backend/compare/v4.1.0..v5.0.0
[4.1.0]: https://github.com/RakuJa/BYBE-backend/compare/v4.0.2..v4.1.0
[4.0.2]: https://github.com/RakuJa/BYBE-backend/compare/v4.0.1..v4.0.2
[4.0.1]: https://github.com/RakuJa/BYBE-backend/compare/v4.0.0..v4.0.1
[4.0.0]: https://github.com/RakuJa/BYBE-backend/compare/v3.0.0..v4.0.0
[3.0.0]: https://github.com/RakuJa/BYBE-backend/compare/v2.7.0..v3.0.0
[2.7.0]: https://github.com/RakuJa/BYBE-backend/compare/v2.6.1..v2.7.0
[2.6.0]: https://github.com/RakuJa/BYBE-backend/compare/v2.5.0..v2.6.0
[2.5.0]: https://github.com/RakuJa/BYBE-backend/compare/v2.4.0..v2.5.0
[2.4.0]: https://github.com/RakuJa/BYBE-backend/compare/v2.3.0..v2.4.0
[2.3.0]: https://github.com/RakuJa/BYBE-backend/compare/v2.2.0..v2.3.0
[2.2.0]: https://github.com/RakuJa/BYBE-backend/compare/v2.1.0..v2.2.0
[2.1.0]: https://github.com/RakuJa/BYBE-backend/compare/v2.0.1..v2.1.0
[2.0.1]: https://github.com/RakuJa/BYBE-backend/compare/v2.0.0..v2.0.1
[2.0.0]: https://github.com/RakuJa/BYBE-backend/compare/v1.3.0..v2.0.0
[1.3.0]: https://github.com/RakuJa/BYBE-backend/compare/v1.2.0..v1.3.0
[1.2.0]: https://github.com/RakuJa/BYBE-backend/compare/v1.0.0..v1.2.0
