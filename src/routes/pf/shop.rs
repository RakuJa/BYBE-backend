...
use bybe::models::item::item_metadata::type_enum::ItemTypeEnum;
use bybe::models::item::item_metadata::type_enum::WeaponTypeEnum;
use bybe::models::item::item_struct::Item;
use bybe::models::item::shield_struct::ShieldData;
use bybe::models::item::shop_structs::ShopTemplateData;
use bybe::models::item::shop_structs::{ItemSortEnum, ShopPaginatedRequest};
use bybe::models::item::shop_structs::{PfShopTemplateEnum, ShopRanges};
use bybe::models::item::shop_structs::{RandomShopData, ShopSortData};
use bybe::models::item::weapon_struct::DamageData;
use bybe::models::item::weapon_struct::WeaponData;
...
#[get("/ranges")]
pub async fn pf_get_shop_ranges(data: web::Data<AppState>) -> actix_web::Result<impl Responder> {
    Ok(web::Json(
        shop_service::get_shop_ranges(&data, GameSystem::Pathfinder).await,
    ))
}
