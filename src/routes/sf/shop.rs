...
use bybe::models::item::shop_structs::{SfShopTemplateEnum, ShopRanges};
use bybe::models::item::weapon_struct::DamageData;
use bybe::models::item::weapon_struct::WeaponData;
use bybe::models::response_data::ResponseItem;
use bybe::models::response_data::ShopListingResponse;
...
pub fn init_docs() -> utoipa::openapi::OpenApi {
    ...
    #[openapi(
        ...
        components(schemas(
            ...
            ShopListingResponse,
            Item,
            RandomShopData<SfShopTemplateEnum>,
            Dice,
            SfShopTemplateEnum,
            ShopTemplateData,
            ItemFieldFilters,
...
#[utoipa::path(
    ...
    tags = ["sf", "shop"],
    request_body(
        content = RandomShopData<SfShopTemplateEnum>,
        content_type = "application/json",
    ),
    params(
